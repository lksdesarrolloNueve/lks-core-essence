...
@Component({
    selector: 'spei-in',
    templateUrl: './spei-in.component.html'
})
export class SpeiInComponent {
    ...
    constructor(private service: GestionGenericaService){
        this.spsPagosRecibidosSPEI();
    }


    spsPagosRecibidosSPEI(){
        ...
        this.service.getListByObjet(jsonRequest, 'spsPagosRecibidosSPEI').subscribe(respGetPagos => {
            this.blockUI.stop();
